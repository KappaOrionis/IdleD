...
class ActiveWindowCapture:
    ...
    def get_thumbnail_base64(self, max_width: int = 320, max_height: int = 180) -> Optional[str]:
        """
        Génère une vignette JPEG compressée en base64 de la fenêtre active pour l'interface UI.
        """
        geom = self.window_controller.get_active_window_geometry()
        ...
        try:
            ...
            print(f"[ActiveWindowCapture] Erreur génération vignette : {e}")
            return None
